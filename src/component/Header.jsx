...
export default function Header() {
  ...
  return (
    <header className="bg-gray-900 flex-col sm:flex-row w-full overflow-x-hidden fixed">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        <div className="flex lg:flex-1 text-white gap-6">
          <a href="#" className="-m-1.5 p-1.5">
            {/* <span className="sr-only">Your Company</span> */}
            <img
              alt="logo"
              //src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=500"
              //src="https://logo.jpeg?color=indigo&shade=500"
              src={logo}
              className="h-8 w-auto"
            />
          </a>
          <p className='mt-1'> OKORO IFEANYI FRANCIS</p>
        </div>
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="https://wa.link/tf3cjl" className="text-sm/6 font-semibold text-white">
